...
public class TollFeeCalculatorTests
{
    ...
    {
        DateTime[] dateTimes = { };
        Assert.Equal(0, _tollFeeCalculator.GetTollFee(new Car(), dateTimes));
    }

    [Fact]
    public void OneEvent()
    {
        DateTime[] dateTimes = { DateTime.Parse("2024-03-04T06:45") }; // A Monday.

        Assert.Equal(13, _tollFeeCalculator.GetTollFee(new Car(), dateTimes));
    }
    ...
    public void SeveralEventsInOnePeriod()
    {
        ...
        Assert.Equal(18, _tollFeeCalculator.GetTollFee(new Car(), dateTimes));
    }
    ...
    public void SeveralEvents()
    {
        ...
        Assert.Equal(31, _tollFeeCalculator.GetTollFee(new Car(), dateTimes));
    }
    ...
    public void NotMoreThanMaximum()
    {
        ...
        Assert.Equal(60, _tollFeeCalculator.GetTollFee(new Car(), dateTimes));
    }
    ...
    public void PeriodEdgeCases()
    {
        ...
        Assert.Equal(36, _tollFeeCalculator.GetTollFee(new Car(), dateTimes));
    ...
    {
        DateTime[] dateTimes = { DateTime.Parse("2024-06-10T15:45") };
        Assert.Equal(0, _tollFeeCalculator.GetTollFee(new Car(), dateTimes));
    }
    ...
    {
        DateTime[] dateTimes = { DateTime.Parse("2024-03-09T15:45") }; // A Saturday.
        Assert.Equal(0, _tollFeeCalculator.GetTollFee(new Car(), dateTimes));
    }
}